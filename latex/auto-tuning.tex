...
\begin{description}[style=nextline]
    \item[Full Search]
        When using Early Stopping together with the FullSearch tuning strategy the total simulation time
        can be reduced from 36.22 seconds to 30.84 seconds, at a maximum allowed slowdown factor of $\approx4$. This results in a reduction of the total simulation time by 14.8\% (\autoref{fig:full_search}).
    \item[Predictive Tuning]
        When using Early Stopping together with the PredictiveTuning strategy the total simulation time can be reduced from 28.62 seconds to 23.23 seconds, at a maximum allowed slowdown factor of $\approx5$. This results in a reduction of the total simulation time by 18.9\% (\autoref{fig:predictive_tuning}).
\end{description}
...
\begin{figure}[H]
    ...
    \caption{Total Simulation Time for Exploding Liquid Simulation with Early Stopping using FullSearch divided into tuning and simulation phases.}
...
\begin{figure}[H]
    ...
    \caption{Total Simulation Time for Exploding Liquid Simulation with Early Stopping using PredictiveTuning divided into tuning and simulation phases.}
