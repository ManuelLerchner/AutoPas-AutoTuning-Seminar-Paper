...
Compared to FullSearch without early stopping, the early stopping mechanism can reduce the total simulation time from \todo{X} to \todo{Y} seconds. This is a reduction of \todo{Z}\%.
